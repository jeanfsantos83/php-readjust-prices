...
<body>
    ...
    <section>        
        ...
        <p>O produto que custava R$<?=number_format($preco, 2, ",", ".")?>, com <strong>R$<?=number_format($aumento, 2, ",", ".")?> de aumento</strong> vai passar a custar <strong>R$<?=number_format($novo, 2, ",", ".")?></strong> a partir de agora.</p>    
    </section>
    <script>
